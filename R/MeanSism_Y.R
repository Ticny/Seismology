...
#' @param Y
#'
#' @return mean magnitude for year
#' @export
#' @import magrittr
#' @import dplyr
#'
...
#'
MeanSY<-function(catalogYM, Y){
  Mean_Y<- catalogYM %>% filter(year==Y) %>%
